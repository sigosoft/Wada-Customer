...
class CouponWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<NurseBookingController>(
      builder: (controller) {
        final coupon = controller.selectedCoupon;
                  ...
                  Row(
                    children: [
                      ...
                      TextStyleInterForSplash(
                        text: hasCoupon ? (coupon['title'] ?? '') : "30% Off",
                    ...
                    child: ElevatedButton(
                      ...
                      child: FittedBox(
                        ...
                        child: TextStyleInterForSplash(
                          text: hasCoupon ? "Applied" : Strings.apply,
