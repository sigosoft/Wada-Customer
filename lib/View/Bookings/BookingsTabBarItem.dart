...
class BookingsTabBarItem extends StatelessWidget {
  ...
  const BookingsTabBarItem({Key? key, required this.swapValue, required this.indexValue})
    : super(key: key);
              ...
              return Padding(
                ...
                child:
                    swapValue
                        ? InkWell(
                            onTap: () {
                              indexValue==0?Get.to(PendingBookingDetails()):indexValue==1?Get.to(UpcomingBookingDetails()):indexValue==2? Get.to(OngoingBookingDetails(type: "completed")):Get.to(OngoingBookingDetails(type: "cancelled"));
                            },
                        ...
                        : InkWell(
                          onTap: () {
                            indexValue==1?Get.to(VideoConsultingScreen()):indexValue==2?Get.to(DoctorsBookingCompleted(bookingType: 'home')):
                            Get.to(DoctorBookingDetails(bookingType: "home"));
                          },
              ...
              return Padding(
                ...
                child:
                    swapValue
                        ? InkWell(
                      onTap: (){
                        Get.to(OngoingBookingDetails(type: "cancelled"));
                      },
                          child: HomeNurseDetailsWidget(
                            showButton: false,
                            buttonText: "",
