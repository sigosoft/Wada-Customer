...
import 'package:waada_customerapp/View/MedicalStore/StoreItem.dart';
...
class MedicalStore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(label: Strings.medicalstore, showCloseIcon: false),
      body: Container(
        color: Colors.white,
        child: Column(
          children: [
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: Strings.searchMedicalStore,
