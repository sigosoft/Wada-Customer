...
class DoctorsRequestCancelledScreen extends StatefulWidget {
  const DoctorsRequestCancelledScreen({super.key, required this.bookingType});

  final String bookingType;

  @override
  State<DoctorsRequestCancelledScreen> createState() =>
      _DoctorsRequestCancelledScreenState();
}

class _DoctorsRequestCancelledScreenState extends State<DoctorsRequestCancelledScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: CustomAppBar(label: Strings.cancelled, showCloseIcon: false),
      body: SafeArea(
        child: SizedBox(
