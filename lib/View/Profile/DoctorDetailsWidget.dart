...
import '../../Resource/Colors.dart' show blackTextColor2, colorPrimary, profileText2;
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius:premiumMembership?BorderRadius.only(topLeft: Radius.circular(8), topRight: Radius.circular(8)): BorderRadius.circular(8),
        ),
        child: Padding(
